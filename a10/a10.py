...
def get_draft_year(name: str) -> str:
    """Gets draft year date of the given person (assuming they played in the NBA)
...
def draft_year(matches: List[str]) -> List[str]:
    """Returns draft year date of named person in matches
...
pa_list: List[Tuple[Pattern, Action]] = [
    ...
    ("when was % drafted".split(), get_draft_year),
    ("in what year was % drafted".split(), get_draft_year),
    (["bye"], bye_action),
]
